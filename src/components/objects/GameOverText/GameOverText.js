...
import { MeshBasicMaterial, Texture, DoubleSide, PlaneGeometry,
    FontLoader, TextGeometry, MeshLambertMaterial, Group } from 'three';
...
class GameOverText extends Group{
    ...
    this.state = {
      ...
      loader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', function(font, scene) {
